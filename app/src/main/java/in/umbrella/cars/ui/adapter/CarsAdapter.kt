...
import `in`.umbrella.cars.data.model.cars
...
class CarsAdapter(internal var context: Context, rlist: MutableList<String>?, valueList: MutableList<cars>?) :
    RecyclerView.Adapter<CarsAdapter.Rholder>() {
    private val rlist: MutableList<String>?
    private val valueList: MutableList<cars>?
